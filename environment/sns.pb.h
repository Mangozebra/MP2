...
template<> ::csce438::UserInfo* Arena::CreateMaybeMessage<::csce438::UserInfo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace csce438 {
...
class UserInfo final :
 ...
 public:
  ...
  int userfollows_size() const;
  private:
  int _internal_userfollows_size() const;
  public:
  void clear_userfollows();
  const std::string& userfollows(int index) const;
  std::string* mutable_userfollows(int index);
  void set_userfollows(int index, const std::string& value);
  void set_userfollows(int index, std::string&& value);
  void set_userfollows(int index, const char* value);
  void set_userfollows(int index, const char* value, size_t size);
  std::string* add_userfollows();
  void add_userfollows(const std::string& value);
  void add_userfollows(std::string&& value);
  void add_userfollows(const char* value);
  void add_userfollows(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& userfollows() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_userfollows();
  private:
  const std::string& _internal_userfollows(int index) const;
  std::string* _internal_add_userfollows();
  public:

  // repeated .csce438.Message timeline = 4;
  int timeline_size() const;
  private:
  int _internal_timeline_size() const;
  public:
  void clear_timeline();
  ::csce438::Message* mutable_timeline(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::csce438::Message >*
      mutable_timeline();
  private:
  const ::csce438::Message& _internal_timeline(int index) const;
  ::csce438::Message* _internal_add_timeline();
  public:
  const ::csce438::Message& timeline(int index) const;
  ::csce438::Message* add_timeline();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::csce438::Message >&
      timeline() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> userfollows_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::csce438::Message > timeline_;
...
inline const std::string& UserInfo::name() const {
  // @@protoc_insertion_point(field_get:csce438.UserInfo.name)
...
void UserInfo::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:csce438.UserInfo.name)
}
inline std::string* UserInfo::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:csce438.UserInfo.name)
  return _s;
}
...
inline std::string* UserInfo::release_name() {
  // @@protoc_insertion_point(field_release:csce438.UserInfo.name)
...
inline void UserInfo::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:csce438.UserInfo.name)
}

// repeated string followers = 2;
inline int UserInfo::_internal_followers_size() const {
  return followers_.size();
}
inline int UserInfo::followers_size() const {
  return _internal_followers_size();
}
inline void UserInfo::clear_followers() {
  followers_.Clear();
}
inline std::string* UserInfo::add_followers() {
  std::string* _s = _internal_add_followers();
  // @@protoc_insertion_point(field_add_mutable:csce438.UserInfo.followers)
  return _s;
}
inline const std::string& UserInfo::_internal_followers(int index) const {
  return followers_.Get(index);
}
inline const std::string& UserInfo::followers(int index) const {
  // @@protoc_insertion_point(field_get:csce438.UserInfo.followers)
  return _internal_followers(index);
}
inline std::string* UserInfo::mutable_followers(int index) {
  // @@protoc_insertion_point(field_mutable:csce438.UserInfo.followers)
  return followers_.Mutable(index);
}
inline void UserInfo::set_followers(int index, const std::string& value) {
  followers_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:csce438.UserInfo.followers)
}
inline void UserInfo::set_followers(int index, std::string&& value) {
  followers_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:csce438.UserInfo.followers)
}
inline void UserInfo::set_followers(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  followers_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:csce438.UserInfo.followers)
}
inline void UserInfo::set_followers(int index, const char* value, size_t size) {
  followers_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:csce438.UserInfo.followers)
}
inline std::string* UserInfo::_internal_add_followers() {
  return followers_.Add();
}
inline void UserInfo::add_followers(const std::string& value) {
  followers_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:csce438.UserInfo.followers)
}
inline void UserInfo::add_followers(std::string&& value) {
  followers_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:csce438.UserInfo.followers)
}
inline void UserInfo::add_followers(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  followers_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:csce438.UserInfo.followers)
}
inline void UserInfo::add_followers(const char* value, size_t size) {
  followers_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:csce438.UserInfo.followers)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
UserInfo::followers() const {
  // @@protoc_insertion_point(field_list:csce438.UserInfo.followers)
  return followers_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
UserInfo::mutable_followers() {
  // @@protoc_insertion_point(field_mutable_list:csce438.UserInfo.followers)
  return &followers_;
}

// repeated string userFollows = 3;
inline int UserInfo::_internal_userfollows_size() const {
  return userfollows_.size();
}
inline int UserInfo::userfollows_size() const {
  return _internal_userfollows_size();
}
inline void UserInfo::clear_userfollows() {
  userfollows_.Clear();
}
inline std::string* UserInfo::add_userfollows() {
  std::string* _s = _internal_add_userfollows();
  // @@protoc_insertion_point(field_add_mutable:csce438.UserInfo.userFollows)
  return _s;
}
inline const std::string& UserInfo::_internal_userfollows(int index) const {
  return userfollows_.Get(index);
}
inline const std::string& UserInfo::userfollows(int index) const {
  // @@protoc_insertion_point(field_get:csce438.UserInfo.userFollows)
  return _internal_userfollows(index);
}
inline std::string* UserInfo::mutable_userfollows(int index) {
  // @@protoc_insertion_point(field_mutable:csce438.UserInfo.userFollows)
  return userfollows_.Mutable(index);
}
inline void UserInfo::set_userfollows(int index, const std::string& value) {
  userfollows_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:csce438.UserInfo.userFollows)
}
inline void UserInfo::set_userfollows(int index, std::string&& value) {
  userfollows_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:csce438.UserInfo.userFollows)
}
inline void UserInfo::set_userfollows(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  userfollows_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:csce438.UserInfo.userFollows)
}
inline void UserInfo::set_userfollows(int index, const char* value, size_t size) {
  userfollows_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:csce438.UserInfo.userFollows)
}
inline std::string* UserInfo::_internal_add_userfollows() {
  return userfollows_.Add();
}
inline void UserInfo::add_userfollows(const std::string& value) {
  userfollows_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:csce438.UserInfo.userFollows)
}
inline void UserInfo::add_userfollows(std::string&& value) {
  userfollows_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:csce438.UserInfo.userFollows)
}
inline void UserInfo::add_userfollows(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  userfollows_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:csce438.UserInfo.userFollows)
}
inline void UserInfo::add_userfollows(const char* value, size_t size) {
  userfollows_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:csce438.UserInfo.userFollows)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
UserInfo::userfollows() const {
  // @@protoc_insertion_point(field_list:csce438.UserInfo.userFollows)
  return userfollows_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
UserInfo::mutable_userfollows() {
  // @@protoc_insertion_point(field_mutable_list:csce438.UserInfo.userFollows)
  return &userfollows_;
}

// repeated .csce438.Message timeline = 4;
inline int UserInfo::_internal_timeline_size() const {
  return timeline_.size();
}
inline int UserInfo::timeline_size() const {
  return _internal_timeline_size();
}
inline void UserInfo::clear_timeline() {
  timeline_.Clear();
}
inline ::csce438::Message* UserInfo::mutable_timeline(int index) {
  // @@protoc_insertion_point(field_mutable:csce438.UserInfo.timeline)
  return timeline_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::csce438::Message >*
UserInfo::mutable_timeline() {
  // @@protoc_insertion_point(field_mutable_list:csce438.UserInfo.timeline)
  return &timeline_;
}
inline const ::csce438::Message& UserInfo::_internal_timeline(int index) const {
  return timeline_.Get(index);
}
inline const ::csce438::Message& UserInfo::timeline(int index) const {
  // @@protoc_insertion_point(field_get:csce438.UserInfo.timeline)
  return _internal_timeline(index);
}
inline ::csce438::Message* UserInfo::_internal_add_timeline() {
  return timeline_.Add();
}
inline ::csce438::Message* UserInfo::add_timeline() {
  ::csce438::Message* _add = _internal_add_timeline();
  // @@protoc_insertion_point(field_add:csce438.UserInfo.timeline)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::csce438::Message >&
UserInfo::timeline() const {
  // @@protoc_insertion_point(field_list:csce438.UserInfo.timeline)
  return timeline_;
}
